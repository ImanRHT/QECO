...
- [DDQN_keras.py](DDQN_keras.py): Dueling double deep Q-network (D3QN) implementation using [Keras](https://keras.io/).
- [DDQN_torch.py](DDQN_torch.py): Dueling double deep Q-network (D3QN) implementation using [PyTorch](https://pytorch.org/get-started/locally/).
